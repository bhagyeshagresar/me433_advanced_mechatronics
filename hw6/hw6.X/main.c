...
//         }
        ...
        unsigned char result_2 = read_fn(0b00001001);//gpio
        
        if((result_2 & 0b00000001) == 0b00000000){
//           _CP0_SET_COUNT(0);
//           while (_CP0_GET_COUNT() < DELAYTIME) {
//                write_fn(0b00001010, 0b10000000); //olat address and set gpio7 to 1
//            }
            write_fn(0b00001010, 0b10000000);
...
//            _CP0_SET_COUNT(0);
//            while (_CP0_GET_COUNT() < DELAYTIME) {
//                write_fn(0b00001010, 0b00000000); //olat address and set gpio7 to 1
//            }
//            write_fn(0b00001010, 0b00000000); //olat address and set gpio7 to 1
            write_fn(0b00001010, 0b00000000);
        }
