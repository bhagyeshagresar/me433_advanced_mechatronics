...
//    int j = 0;
    ...
    while (1) {
        float t = t + 0.01;
//        float sin_v = sin(2*M_PI*2*t)+1;

        
        float sin_wave = 128*(sin(2*M_PI*2*t) + 255);
        
        unsigned char v = sin_wave;
//        unsigned char v = 0;
        ...
        //send the sine way
        LATAbits.LATA0 = 0;        
        unsigned char s2 = s >> 8;
        unsigned char spio_1 = spi_io(s2); //first 8 bits
...
////    
        unsigned char v2 = y;
        unsigned char a_or_b_2 = 0;
        unsigned short s_tri = make16(a_or_b_2, v2);
        
        LATAbits.LATA0 = 0;        
        unsigned char s2_tri = s_tri >> 8;
        unsigned char spio_1_tri = spi_io(s2_tri); //first 8 bits
        unsigned char spio_2_tri = spi_io(s_tri); //last 8 bits
        LATAbits.LATA0 = 1;
